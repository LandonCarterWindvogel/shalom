...
/**
 * Chatty — the site's assistant, not a business partner. Kept here (rather
 * than in `partners`) so it never renders in the "who we work with" strip.
 * The launcher in js/assistant.js reads this directly.
 */
